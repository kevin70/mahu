...
import { NewMarketAssetForm } from './NewMarketAssetForm';
import { EditMarketAssetForm } from './EditMarketAssetForm';
...
export const MarketAssetList = () => {
  ...
  const { data, isFetching, refetch } = useQuery({
    queryKey: ['MarketAssetList', queryOffsetLimit, queryFilter, querySort],
    async queryFn() {
  ...
  return (
    <PageContainer>
      <ProTable
        ...
        toolbar={{
          search: searchForm,
          actions: [<NewMarketAssetForm onSuccess={refetch} />],
        }}
        loading={isFetching}
        dataSource={data}
        ...
        columns={[
          ...
          },
          {
            ...
            fixed: 'right',
            render: (_dom, row) => [
              <EditMarketAssetForm id={row.id} onSuccess={refetch} />,
