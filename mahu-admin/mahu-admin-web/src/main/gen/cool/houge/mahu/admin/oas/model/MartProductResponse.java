...
public class MartProductResponse {
    ...
    private List<@Valid MartProductResponseAttributesInner> attributes;
    /**
     * 产品变体
     */
  
    @com.fasterxml.jackson.annotation.JsonProperty("variants")
    private List<@Valid MartProductResponseVariantsInner> variants;
}
