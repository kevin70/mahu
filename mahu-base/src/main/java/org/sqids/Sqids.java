...
public class Sqids {
    ...
    private Sqids(final Builder builder) {
        ...
        final List<String> alphabetChars =
                new ArrayList<>(Arrays.asList(alphabet.toLowerCase().split("")));
    ...
    private String encodeNumbers(final List<Long> numbers, final int increment) {
        ...
        final StringBuilder alphabetB =
                new StringBuilder(this.alphabet.substring((int) offset)).append(this.alphabet, 0, (int) offset);
